  ...
  <div align="center"> 
  	...
  	<form action="${path}/MajustoryController">
	  	...
	  	<table border=1>
	  		...
	  		<tr>
	  			<td>암호</td>
	  			<td><input type=text name=mpassword1 required ></td>
	  		</tr>
	  		<tr>
	  			<td>전화번호</td>
	  		...
	  		<tr>
	  			<td>주소</td>
	  			<td>
	  				<input type="text" id="maddr1" name="maddr1" placeholder="우편번호">
						<input type="button" onclick="sample2_execDaumPostcode()" value="우편번호 찾기"><br>
						<input type="text" id="maddr2" name="maddr2" placeholder="주소"><br>
						<input type="text" id="maddr3" name="maddr3" placeholder="상세주소">
	  		...
	  		<tr>
	  			<td>성별</td>
	  			<td><input type=text name=mgender ></td>
	  		</tr>
	  		<tr>
