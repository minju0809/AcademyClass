...
<%
DataVo  m =(DataVo) request.getAttribute("m"); 
...
<br>
	...
	<h2> 다문화 가족 지원센터  </h2>
      ...
      <!-- 로드뷰 사용하기  -->
       ...
       <tr> <td> 순번  </td>   <td><%=m.getIdx()%> </td> </tr>
       <tr> <td> 센터이름 </td> <td><%=m.getCnterNm()%>   </td> </tr>
       <tr> <td> 대표자  </td>  <td><%=m.getCnterChNm()%>    </td> </tr>
       <tr> <td> 홈페이지 </td> <td><%=m.getHmpgAddr()%>  </td> </tr>
       <tr> <td> 주소  </td>   <td> <%=m.getRoadNmAddr()%>   </td> </tr>
      </table>    
